...
public class UsuarioControllerTest {
	...
	// Não deve permitir a duplicação do Usuário
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService
				.cadastrarUsuario(new Usuario(0L, "Maria Carolina", "maria_carolina@email.com.br", "maria123", "-"));

		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Maria Carolina Ramos",
				"maria_ramos@email.com.br", "maria123", "-");
